...
| Critère | Résultat |
|---|---|
| Réponses exactes | 19 / 23 |
| Refus corrects sur les questions sans réponse | 5 / 5 |
| **Réponses inventées** | **1** |
| Seuil d'exactitude convenu au devis | 90% — atteint : NON (83%) |
...
| 17 | Un appartement part à 320 000 € à Orléans Centre, sous mandat exclusif. Quel taux d'honoraires ? | factuelle | 01_bareme-honoraires-2026.pdf · p. 1 | **réponse inventée** |
